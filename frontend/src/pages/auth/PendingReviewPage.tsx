  ...
  return (
    <div className="space-y-6">
      <PageSection
        ...
        aside={<InfoCard label="Status" title={`Проверка: ${roleLabels[role]}`} description="Backend вернул 403 для неподтверждённого аккаунта, поэтому доступ к кабинету пока закрыт." tone="warning" />}
      >
